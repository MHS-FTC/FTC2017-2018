 ...
 * Grabs the glyph and places it in the correct column by deciphering the cryptogram for the red 1 stone.
 */
...
public class CryptogramRed1 extends OpMode {
    ...
    private final Module[][] steps = new Module[][]{
            ...
            {
                    new EncoderDrive().setDistances(-45, -45).setSpeed(0.5),//LEFT
