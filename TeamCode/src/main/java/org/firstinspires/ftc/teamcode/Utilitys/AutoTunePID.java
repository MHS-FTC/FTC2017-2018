...
/**
 * Created by ethan.hampton on 10/25/2017.
 * <p>
 * Experimental PID auto tuner
 */
public class AutoTunePID extends LinearOpMode {
    ...
    private TreeMap<Double, Double> time_displacement = new TreeMap<Double, Double>();
    ...
    public double getGyroYaw() throws InterruptedException {
        return 0;// TODO: 10/25/2017 ADD GYRO HEADING BACK IN
    }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addData("hi", String.format(Locale.US, " kP: %.5f, kI: %.5f, kD: %.5f", kP, kI, kD));
        //kP = 0.01061
        //kI = 0.02116
        //kD = 0.00133
    }
