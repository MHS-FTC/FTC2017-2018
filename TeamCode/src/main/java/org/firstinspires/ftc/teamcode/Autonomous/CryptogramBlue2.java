 ...
 * Grabs the glyph and places it in the correct column by deciphering the cryptogram for the blue 2 stone.
 */

@Autonomous(name = "BLUE2: Cryptogram", group = "Blue")
public class CryptogramBlue2 extends OpMode {
